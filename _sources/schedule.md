...
<li><a href="/cs349-fall-2024/hw-instructions">Join the course on Gradescope</a></li>
    ...
    <tr class="col_headers light_row">
      <td class="normalday">
        ...
        <ul class="day_agenda">
          ...
          <li>
            <span class="tag due_tag">Due:</span>
            <span>HW2 Checkpoint: Finish all parts of HW2 up to (and not including) "Joint distributions as Generative Models". Submit it on gradescope.</span>
          </li>
        </ul>
      </td>
      <td class="normalday">
